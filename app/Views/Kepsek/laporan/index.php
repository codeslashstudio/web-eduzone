...
<head>
    ...
    <title>Laporan Akademik - EduZone Kepala Sekolah</title>
...
<body class="bg-gray-50">
    ...
    <aside id="sidebar" class="sidebar sidebar-expanded fixed left-0 top-0 h-screen bg-white shadow-2xl z-50 overflow-y-auto">
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                <a href="<?= base_url('kepsek/laporan') ?>" class="menu-item active flex items-center space-x-3 px-4 py-3 rounded-xl">
    ...
    <div id="main-content" class="ml-[280px] transition-all duration-300">
        ...
        <main class="p-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 mb-8" data-aos="fade-up">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                    ...
                    <div class="flex items-end space-x-3">
                        <button onclick="exportToExcel()" class="flex items-center space-x-2 px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:shadow-lg transition-all">
                            <i class="fas fa-file-excel"></i>
                            <span class="font-semibold">Export Excel</span>
                        </button>
                        <button onclick="printReport()" class="flex items-center space-x-2 px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-all">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-xl" data-aos="fade-up">
                ...
                <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 text-white shadow-xl" data-aos="fade-up" data-aos-delay="100">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-14 h-14 bg-white/20 rounded-xl flex items-center justify-center">
                    ...
                    <p class="text-purple-100 text-sm font-medium">Rata-rata Keseluruhan</p>
                </div>

                <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-2xl p-6 text-white shadow-xl" data-aos="fade-up" data-aos-delay="200">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-14 h-14 bg-white/20 rounded-xl flex items-center justify-center">
                    ...
                    <p class="text-indigo-100 text-sm font-medium">Nilai Tertinggi</p>
                </div>

                <div class="bg-gradient-to-br from-violet-500 to-violet-600 rounded-2xl p-6 text-white shadow-xl" data-aos="fade-up" data-aos-delay="300">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-14 h-14 bg-white/20 rounded-xl flex items-center justify-center">
                    ...
                    <p class="text-violet-100 text-sm font-medium">Total Siswa</p>
                </div>
            </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200" id="tableBody">
                            ...
                            ?>
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <span class="text-sm font-bold text-purple-600"><?= number_format($l['rata_rata'], 1) ?></span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <span class="text-sm font-bold text-blue-600"><?= number_format($l['tertinggi'], 1) ?></span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <a href="<?= base_url('kepsek/laporan/detail/' . $l['kelas'] . '-' . str_replace(' ', '-', $l['jurusan'])) ?>"
    ...
    <script>
        ...
        function exportToExcel() {
            ...
            XLSX.writeFile(wb, 'Laporan_Akademik_Kepsek_' + new Date().toISOString().slice(0, 10) + '.xlsx');
        }
