...
<body class="bg-gray-50">
        ...
        <main class="p-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 mb-6" data-aos="fade-up">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                    <div class="flex items-center space-x-4">
                        <!-- <a href="<?= base_url('kepsek/siswa/add') ?>" class="flex items-center space-x-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-xl hover:shadow-xl transition-all transform hover:scale-105">
    ...
    <script>
        ...
        function confirmDelete(id, name) {
            ...
            document.getElementById('deleteForm').action = '<?= base_url('kepsek/siswa/delete/') ?>' + id;
