...
<body class="bg-gray-50">
    ...
    <div id="main-content" class="ml-[280px] transition-all duration-300">
            ...
            <div class="flex items-center justify-between px-8 py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Tambahkan data siswa baru</p>
                    </div>
                </div>
        ...
        <main class="p-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8" data-aos="fade-up">
                <form action="<?= base_url('kepsek/siswa/create') ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                            ...
                            <div>
                                ...
                                <select id="idjurusan" name="idjurusan"
                                    ...
                                    <?php foreach ($jurusan as $j): ?>
                                        <option value="<?= $j['idjurusan'] ?>" <?= old('idjurusan') == $j['idjurusan'] ? 'selected' : '' ?>>
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                        <a href="<?= base_url('kepsek/siswa') ?>"
                            class="px-6 py-3 bg-gray-200 text-gray-700 rounded-xl hover:bg-gray-300 transition-all font-semibold">
                            <i class="fas fa-times mr-2"></i>Batal
                        </a>
                        <button type="submit"
                            class="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:shadow-xl transition-all font-semibold">
    ...
    <script>
        ...
        // Validate NISN input (only numbers)
