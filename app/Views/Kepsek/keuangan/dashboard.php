...
<head>
    ...
    <title>Dashboard Keuangan - EduZone Kepala Sekolah</title>
...
<body class="bg-gray-50">
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                <div>
                    ...
                    <div class="submenu active ml-4 mt-2 space-y-1 sidebar-text" id="keuanganSubmenu">
                        <a href="<?= base_url('kepsek/keuangan') ?>" class="flex items-center space-x-3 px-4 py-2 rounded-lg text-white bg-white/20 hover:bg-white/30">
                            <i class="fas fa-chart-pie text-sm w-5"></i>
                            <span class="text-sm">Dashboard</span>
                        </a>
                        <a href="<?= base_url('kepsek/keuangan/pemasukan') ?>" class="flex items-center space-x-3 px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-100">
                            <i class="fas fa-arrow-down text-sm w-5"></i>
                            <span class="text-sm">Pemasukan</span>
                        </a>
                        <a href="<?= base_url('kepsek/keuangan/pengeluaran') ?>" class="flex items-center space-x-3 px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-100">
                            <i class="fas fa-arrow-up text-sm w-5"></i>
                            <span class="text-sm">Pengeluaran</span>
                        </a>
                        <a href="<?= base_url('kepsek/keuangan/bos') ?>" class="flex items-center space-x-3 px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-100">
                            <i class="fas fa-file-invoice-dollar text-sm w-5"></i>
                            <span class="text-sm">BOS/BOP</span>
                        </a>
                        <a href="<?= base_url('kepsek/keuangan/persetujuan') ?>" class="flex items-center space-x-3 px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-100">
                            <i class="fas fa-check-circle text-sm w-5"></i>
                            <span class="text-sm">Persetujuan</span>
                        </a>
                        <a href="<?= base_url('kepsek/keuangan/audit') ?>" class="flex items-center space-x-3 px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-100">
        ...
        <main class="p-8">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                    <div class="flex items-center space-x-4">
                        <div>
                            ...
                            <select id="periodeFilter" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="stat-card bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-xl" data-aos="fade-up">
                    ...
                    <div class="mt-4 pt-4 border-t border-white/20">
                        <a href="<?= base_url('kepsek/keuangan/pemasukan') ?>" class="text-sm hover:underline flex items-center">
                ...
                <div class="stat-card bg-gradient-to-br from-red-500 to-red-600 rounded-2xl p-6 text-white shadow-xl" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="mt-4 pt-4 border-t border-white/20">
                        <a href="<?= base_url('kepsek/keuangan/pengeluaran') ?>" class="text-sm hover:underline flex items-center">
                            Lihat Detail <i class="fas fa-arrow-right ml-2"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="stat-card bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 text-white shadow-xl" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="mt-4 pt-4 border-t border-white/20">
                        <a href="<?= base_url('kepsek/keuangan/bos') ?>" class="text-sm hover:underline flex items-center">
                            Lihat Detail <i class="fas fa-arrow-right ml-2"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6" data-aos="fade-up">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="<?= base_url('kepsek/keuangan/audit') ?>" class="text-sm text-blue-600 hover:underline">Lihat Semua</a>
                    </div>
                    <div class="space-y-3">
                        <!-- Transaction Item -->
                        <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition">
                            ...
                            <span class="font-bold text-blue-600">+Rp 45.5 Jt</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition">
                            ...
                            <span class="font-bold text-blue-600">+Rp 75 Jt</span>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="<?= base_url('kepsek/keuangan/persetujuan') ?>" class="text-sm text-blue-600 hover:underline">Lihat Semua</a>
                    </div>
                    <div class="space-y-3">
                        <!-- Approval Item -->
                        <div class="p-4 border-l-4 border-orange-500 bg-orange-50 rounded-lg">
                            ...
                            <div class="flex space-x-2">
                                <button class="flex-1 px-3 py-1 bg-blue-500 text-white rounded text-sm hover:bg-blue-600">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6" data-aos="fade-up">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    <a href="<?= base_url('kepsek/keuangan/pemasukan/add') ?>" class="flex flex-col items-center justify-center p-4 bg-blue-50 rounded-xl hover:bg-blue-100 transition group">
                    ...
                    <a href="<?= base_url('kepsek/keuangan/pengeluaran/add') ?>" class="flex flex-col items-center justify-center p-4 bg-red-50 rounded-xl hover:bg-red-100 transition group">
                    ...
                    <a href="<?= base_url('kepsek/keuangan/bos') ?>" class="flex flex-col items-center justify-center p-4 bg-purple-50 rounded-xl hover:bg-purple-100 transition group">
                    ...
                    <a href="<?= base_url('kepsek/keuangan/persetujuan') ?>" class="flex flex-col items-center justify-center p-4 bg-orange-50 rounded-xl hover:bg-orange-100 transition group">
                    ...
                    <a href="<?= base_url('kepsek/keuangan/audit') ?>" class="flex flex-col items-center justify-center p-4 bg-indigo-50 rounded-xl hover:bg-indigo-100 transition group">
                        <div class="w-12 h-12 bg-indigo-500 rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition">
                            <i class="fas fa-history text-white text-xl"></i>
                        </div>
                        <span class="text-sm font-semibold text-gray-700 text-center">Riwayat</span>
                    </a>

                    <button onclick="cetakLaporan()" class="flex flex-col items-center justify-center p-4 bg-cyan-50 rounded-xl hover:bg-cyan-100 transition group">
                        <div class="w-12 h-12 bg-cyan-500 rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition">
        ...
        <footer class="bg-white border-t border-gray-200 py-6 mt-12">
            <div class="px-8">
                <div class="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <p class="text-gray-500 text-sm">Version 1.0.0 - Kepala Sekolah</p>
                </div>
            </div>
        </footer>
    </div>
    ...
    <script>
        ...
        function cetakLaporan() {
            window.open('<?= base_url("kepsek/keuangan/cetak") ?>', '_blank');
        }
    </script>
</body>
