...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold mb-0">✏️ Edit Presensi Guru</h4>
        <a href="/presensi-guru?date=<?= $attendance['date'] ?>" class="btn btn-outline-secondary">
    ...
    <div class="card shadow-sm" style="max-width: 600px;">
        ...
        <div class="card-body">
            <form method="POST" action="/presensi-guru/update/<?= $attendance['id'] ?>">
                <?= csrf_field() ?>
