...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold mb-0">📋 Presensi Siswa</h4>
        <div class="d-flex gap-2">
            <a href="/presensi-siswa/input?date=<?= $date ?>&grade=<?= $grade ?>&major_id=<?= $major_id ?>&class_group=<?= $class_group ?>" class="btn btn-primary">
                <i class="bi bi-plus-circle"></i> Input Presensi
            </a>
            <a href="/presensi-siswa/rekap" class="btn btn-outline-secondary">
    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-body">
            <form method="GET" action="/presensi-siswa" class="row g-3 align-items-end">
                <div class="col-md-2">
                        ...
                        <?php else: ?>
                            <?php foreach ($attendances as $i => $row): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/presensi-siswa/edit/<?= $row['id'] ?>" class="btn btn-sm btn-outline-primary">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <a href="/presensi-siswa/delete/<?= $row['id'] ?>"
