    ...
    <div id="main-content" class="ml-[280px] transition-all duration-300">
        ...
        <main class="p-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden mb-6" data-aos="fade-up">
                <div class="bg-gradient-to-r from-green-600 to-teal-600 h-32"></div>
                <div class="px-8 pb-8">
                    <div class="flex flex-col md:flex-row items-start md:items-end -mt-16 space-y-4 md:space-y-0 md:space-x-6">
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <?php else: ?>
                                <div class="w-32 h-32 rounded-2xl bg-gradient-to-br from-green-500 to-teal-500 flex items-center justify-center text-white font-bold text-5xl border-4 border-white shadow-xl">
                        ...
                        <div class="flex space-x-2 no-print">
                            <a href="<?= base_url('tu/siswa/edit/' . $siswa['idsiswa']) ?>"
        ...
        <div class="bg-white rounded-2xl p-8 max-w-md w-full mx-4 transform transition-all">
            <div class="text-center">
                ...
                <div class="flex space-x-4">
                    ...
                    <form action="<?= base_url('tu/siswa/delete/' . $siswa['idsiswa']) ?>" method="POST" class="flex-1">
