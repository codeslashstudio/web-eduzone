    ...
    <aside id="sidebar" class="sidebar sidebar-expanded fixed left-0 top-0 h-screen bg-white shadow-2xl z-50 overflow-y-auto">
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                <a href="<?= base_url('tu/guru') ?>" class="menu-item active flex items-center space-x-3 px-4 py-3 rounded-xl">
        ...
        <main class="p-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden" data-aos="fade-up">
                <div class="bg-gradient-to-r from-green-600 to-blue-600 p-6">
                    ...
                    <p class="text-green-100 mt-2">Lengkapi semua data dengan benar</p>
                </div>

                <form action="<?= base_url('tu/guru/store') ?>" method="POST" enctype="multipart/form-data" class="p-8">
                    <?= csrf_field() ?>

                    <!-- Data Pribadi -->
                    <div class="mb-8">
                        <h3 class="text-lg font-bold text-gray-900 mb-4 pb-2 border-b-2 border-green-200 flex items-center">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="nip" required
                                    class="form-control w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div id="imagePreview" class="mt-4">
                                    <img id="preview" class="rounded-lg border-2 border-green-200" alt="Preview">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                        ...
                        <button type="submit"
                            class="px-6 py-3 bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-lg font-semibold hover:shadow-lg transition-all">
