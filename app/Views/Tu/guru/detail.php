            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden" data-aos="fade-right">
                        <div class="bg-gradient-to-r from-green-600 to-blue-600 p-6 text-center">
                            ...
                            <p class="text-green-100 mt-1"><?= esc($guru['jabatan']) ?></p>
                        </div>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                ...
                                $statusColors = [
                                    ...
                                    'Kontrak' => 'bg-green-100 text-green-800'
                                ];
                            ...
                            <div class="pt-4 space-y-2">
                                <a href="<?= base_url('tu/guru/edit/' . $guru['idguru']) ?>"
                                ...
                                <form action="<?= base_url('tu/guru/delete/' . $guru['idguru']) ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus guru <?= esc($guru['nama']) ?>?\n\nData akan dinonaktifkan dari sistem.')">
                                    <?= csrf_field() ?>
                                    <button type="submit"
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="info-card bg-white rounded-2xl shadow-lg p-6" data-aos="fade-up">
                        <h3 class="text-xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-green-200 flex items-center">
    ...
    <script>
        ...
        function confirmDelete(id, nama) {
            if (confirm(`Apakah Anda yakin ingin menghapus guru ${nama}?`)) {
                window.location.href = `<?= base_url('tu/guru/delete/') ?>${id}`;
            }
        }
    </script>
</body>
