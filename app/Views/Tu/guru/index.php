...
<head>
    ...
    <title>Data Guru - EduZone TU</title>
        ...
        <main class="p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-gradient-to-br from-teal-500 to-teal-600 rounded-2xl p-6 text-white shadow-xl" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="text-teal-100 text-sm font-medium">Guru PNS</p>
                </div>
                ...
                <div class="bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-2xl p-6 text-white shadow-xl" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="text-cyan-100 text-sm font-medium">Guru PPPK</p>
                </div>
                ...
                <div class="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl p-6 text-white shadow-xl" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <p class="text-emerald-100 text-sm font-medium">Guru Honorer</p>
                </div>
            </div>
                ...
                <div class="p-6 border-b border-gray-200">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <!-- Add Button -->
                            <a href="<?= base_url('tu/guru/add') ?>"
                                class="flex items-center space-x-2 px-6 py-2 bg-gradient-to-r from-green-600 to-teal-600 text-white rounded-lg hover:shadow-lg transition-all">
                                ...
                                <?php foreach ($guru as $index => $g): ?>
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <?php else: ?>
                                                <div class="w-12 h-12 bg-gradient-to-br from-green-400 to-teal-400 rounded-full flex items-center justify-center text-white font-bold text-lg">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            $statusColors = [
                                                ...
                                                'PPPK' => 'bg-teal-100 text-teal-800',
                                                'Honorer' => 'bg-yellow-100 text-yellow-800',
                                                'Kontrak' => 'bg-cyan-100 text-cyan-800'
                                            ];
    ...
    <script>
        ...
        function confirmDelete(id, nama) {
            if (confirm(`Apakah Anda yakin ingin menghapus guru ${nama}?\n\nData akan dinonaktifkan dari sistem.`)) {
                ...
                form.method = 'POST';
                form.action = `<?= base_url('tu/guru/delete/') ?>${id}`;
