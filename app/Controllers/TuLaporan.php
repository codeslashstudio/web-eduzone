...
class TuLaporan extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('Tu/laporan/index', $data);
    }
    ...
    public function detail($kelas)
    {
        ...
        if (!$detail) {
            return redirect()->to(base_url('tu/laporan'))->with('error', 'Data kelas tidak ditemukan');
        }
        ...
        return view('Tu/laporan/detail', $data);
    }
    ...
    public function exportPdf()
    {
        ...
        // Load view for PDF
        return view('Tu/laporan/pdf', $data);
    }
