...
class KepsekSiswa extends BaseController
{
    ...
    private function checkAuth()
    {
        ...
        if (session()->get('selectedRole') !== 'kepsek') {
    ...
    public function add()
    {
        ...
        return view('Kepsek/siswa/add', $data);
    }
    ...
    public function create()
    {
        ...
        $rules = [
            ...
            'nisn' => [
                'rules' => 'required|exact_length[10]|numeric|is_unique[data_siswa.nisn]',
                'errors' => [
        ...
        if ($this->siswaModel->insert($data)) {
            return redirect()->to('/kepsek/siswa')->with('success', 'Data siswa berhasil ditambahkan');
        } else {
    ...
    public function edit($id)
    {
        ...
        if (!$data['siswa']) {
            return redirect()->to('/kepsek/siswa')->with('error', 'Data siswa tidak ditemukan');
        }

        return view('Kepsek/siswa/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        $rules = [
            ...
            'nisn' => [
                'rules' => "required|exact_length[10]|numeric|is_unique[data_siswa.nisn,idsiswa,{$id}]",
                'errors' => [
                    'required' => 'NISN harus diisi',
                    'exact_length' => 'NISN harus 10 digit',
                    'numeric' => 'NISN harus berupa angka',
        ...
        if ($this->siswaModel->update($id, $data)) {
            return redirect()->to('/kepsek/siswa')->with('success', 'Data siswa berhasil diperbarui');
        } else {
    ...
    public function delete($id)
    {
        ...
        if ($this->siswaModel->delete($id)) {
            return redirect()->to('/kepsek/siswa')->with('success', 'Data siswa berhasil dihapus');
        } else {
            return redirect()->to('/kepsek/siswa')->with('error', 'Gagal menghapus data siswa');
        }
    }
    ...
    public function detail($id)
    {
        ...
        return view('Kepsek/siswa/detail', $data);
    }
}
